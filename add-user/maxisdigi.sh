...
patchtls=/joysmart-vmesswstls
patchnontls=/joysmart-vmesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
bug_addr=${address}.
...
patchtls=/joysmart-vlesswstls
patchnontls=/joysmart-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
bug_addr=${address}.
...
patchtls=/joysmart-trojanwstls
patchnone=/joysmart-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
