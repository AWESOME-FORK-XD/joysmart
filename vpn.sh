...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/${GitUser}/joysmart/main/vpn.zip
unzip vpn.zip
rm -f vpn.zip
...
############## WELCOME TO JOYSMART ###############
############## By JOYSMART ###############
setenv FRIENDLY_NAME "JOYSMART TCP"
client
dev tun
proto tcp
...
############## WELCOME TO JOYSMART ###############
############## By JOYSMART ###############
setenv FRIENDLY_NAME "JOYSMART UDP"
client
dev tun
proto udp
setenv CLIENT_CERT 0
...
############## WELCOME TO JOYSMART ###############
############## BY JOYSMART ###############
setenv FRIENDLY_NAME "JOYSMART SSL"
client
dev tun
proto tcp
setenv CLIENT_CERT 0
