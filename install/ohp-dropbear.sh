...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/${GitUser}/joysmart/main/ohp"
...
setenv FRIENDLY_NAME "JOYSMART OHP"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By JOYSMART
Documentation=https://t.me/trikjoysmart
